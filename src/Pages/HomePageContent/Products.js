...
function Products() {
  return (
    <>
      ...
      <div className="bg-white py-3 shadow-sm rounded-md overflow-x-hidden scrollbar-hide overflow-y-auto  overflow-x-hidden scrollbar-hide overflow-y-auto ">
        <div className=" text-lg text-[#247158] mb-3 px-5 px-5">
