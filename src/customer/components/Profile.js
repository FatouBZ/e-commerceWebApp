...
function Profile() {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="flex x justify-start ">
        <div className="flex flex-row w-full rounded-lg p-1">
          <div className="flex flex-col w-[100%] justify-center">
            <h1 className="text-4xl text-[#247158] font-bold mb-5">
              Personal Information
            </h1>
            <div className="flex w-[100%]  mb-2">
              <img
                className="w-32 h-32 outline outline-1 outline-[#247158] rounded-full bg-[#000]"
                src="./asset/2.jpg"
                alt="profile"
              />
              <div className="text-[#247158]">
                <p className="flex ml-2 mt-10 mr-10 ">Fatou Bintou</p>
                <p className=" ml-2 font-bold cursor-pointer underline ">
                  Change
                </p>
              </div>
            </div>
            <div className=" flex flex-col text-left">
              <input
                ...
                className="block p-2 mb-2 rounded w-full outline outline-1 outline-[#247158] bg-transparent  "
                name="firstname"
                onBlur={handleBlur}
            ...
            <div>
              <button
                type="submit"
                className="text-[#fff] rounded-md mt-3 bg-[#247158] font-bold w-full p-2"
              >
                Save
              </button>
            </div>
