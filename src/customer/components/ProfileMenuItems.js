...
function ProfileMenuItems() {
  return (
    <>
      ...
      <Link
        to="/profileInformation/account"
        className="flex items-center hover:bg-[#6AB29B] selected focus:font-bold
      ...
      <Link
        to="/profileInformation/order"
        className="flex items-center  hover:bg-[#6AB29B]  focus:font-bold focus:border-none p-2 mb-3 focus:bg-[#6AB29B] w-full  rounded"
      >
