...
const OrdersTable = () => {
  ...
  const [rowsLimit, setRowsLimit] = useState(7);
  ...
  return (
    <div className="p-4">
      <div className="">
        <div>
          <h1 className="text-2xl text-start py-3">ORDERS</h1>
        </div>
        <div className="">
          <table className="table-auto overflow-scroll w-full text-left font-inter border ">
